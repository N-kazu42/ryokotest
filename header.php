      ...
      <div class="header-inner">
        <div class="logo">
          <a class="logo-header" href="/">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/common/logo-ryoko-main.svg" class="main-logo" alt="ryoko-sangyo.co" />
            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/common/logo-ryoko-fixed.svg" class="fixed-logo" alt="ryoko-sangyo.co" />
          </a>
        </div>
